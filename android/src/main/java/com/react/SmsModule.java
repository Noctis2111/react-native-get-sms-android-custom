...
import android.telephony.SubscriptionInfo; // ajout
import android.telephony.SubscriptionManager; // ajout
...
public class SmsModule extends ReactContextBaseJavaModule /* implements LoaderManager.LoaderCallbacks<Cursor> */ {
    ...
    @ReactMethod
    // public void autoSend(String phoneNumber, String message, final Callback
    // errorCallback,
        ...
        try {
            ...
            context.registerReceiver(new BroadcastReceiver() {
                ...
                public void onReceive(Context arg0, Intent arg1) {
                    System.out.println("----- registerReceiver -----  " + getResultCode());
                    switch (getResultCode()) {
                        case Activity.RESULT_OK:
                            System.out.println("----- switch RESULT_OK -----");
                            sendCallback("SMS sent", true);
                            break;
                        case SmsManager.RESULT_ERROR_GENERIC_FAILURE:
                            sendCallback("Generic failure", false);
                            System.out.println("----- switch RESULT_ERROR_GENERIC_FAILURE -----");
                            break;
                        case SmsManager.RESULT_ERROR_NO_SERVICE:
                            sendCallback("No service", false);
                            System.out.println("----- switch RESULT_ERROR_NO_SERVICE  -----");
                            break;
                        case SmsManager.RESULT_ERROR_NULL_PDU:
                            sendCallback("Null PDU", false);
                            System.out.println("----- switch RESULT_ERROR_NULL_PDU -----");
                            break;
                        case SmsManager.RESULT_ERROR_RADIO_OFF:
                            sendCallback("Radio off", false);
                            System.out.println("----- switch RESULT_ERROR_RADIO_OFF -----");
                            break;
                        // ajout du default pour toujours avoir un retour
                        default:
                            sendCallback("default error ", false);
                            System.out.println("----- switch RESULT_DEFAULT_ERROR -----");
                            break;
                    }
                }
